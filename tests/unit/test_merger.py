    ...
    delta = WorldStateDelta(
        ...
        operations=[
            DeltaChange(
                ...
                payload={"id": "node-1", "type": "CHARACTER", "properties": {}, "confidence": 0.9},
    ...
    delta = WorldStateDelta(
        ...
        operations=[
            DeltaChange(
                ...
                payload={"id": "edge-1", "source": "n1", "target": "n2", "relation": "LIKES", "confidence": 0.8},
...
def test_merger_unlink_edge():
    ...
    state.semantic.knowledge_graph.edges.append(
        KnowledgeGraphEdge(id="edge-1", source="n1", target="n2", relation="LIKES", confidence=0.9)
    )
